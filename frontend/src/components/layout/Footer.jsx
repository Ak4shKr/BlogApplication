    ...
    >
      <div className="container">
        <div className="about">
          <h3>About</h3>
          <p>
            A blog application is a platform that facilitates the creation,
            publishing, and management of blog posts. These applications are
            used by individuals, companies, and other entities to share
            insights, news, and stories on various topics. Below, I'll introduce
            you to what a blog application does and its uses.
          ...
          <p>
            <span>Email:</span>akashsahabanaul@gmail.com
          </p>
          <p>
            <span>Phone:</span>7667008758
          </p>
        </div>
      ...
      <div className="container">
        ...
        <div className="links">
          <Link to={"https://github.com/Ak4shKr"} target="_blank">
            <FaGitSquare />
          </Link>
          ...
          <Link
            to={"https://www.linkedin.com/in/akash-saha-cod/"}
            target="_blank"
          >
            <AiFillLinkedin />
          </Link>
